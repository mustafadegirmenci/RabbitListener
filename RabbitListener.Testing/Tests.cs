...
//     {
//         var errorCode = await _httpService.SendRequestAsync("");
//         
...
//     {
//         var errorCode = await _httpService.SendRequestAsync(urlToTest);
//         
...
//     {
//         var state = _queueListener.StartListening(queueNameToTest);
//         
...
//         
//         _rabbitService.Init();
//         await _rabbitService.SendMultipleRequests(loggingEnabled: false);
...
//         Assert.DoesNotThrow(() =>
//         {
//             _loggerService.LogResponseSuccess(statusToLog);
//         });
//     }
//     
//     [TestCase("example")]
